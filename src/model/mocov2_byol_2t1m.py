...
class MoCo_byol_2t1m_Model(nn.Module):
    def __init__(self, args, queue_size=65536, momentum=0.999, temperature=0.07):
        ...
        '''
        super(MoCo_byol_2t1m_Model, self).__init__()
        ...
        self.encoder_a = getattr(models, args.model)(
            args, num_classes=128)  # Key Encoder
        ...
        self.encoder_a.fc = models.projection_MLP(args)
    ...
    def forward(self, x_q, x_k, x_a):
        ...
        feat_a_byol1 = self.prodictor(feat_a)
        fea_k_byol2 = self.prodictor(self.encoder_a(x_k))
        ...
        logit2 = loss_fn(feat_a_byol1, feat_k)
        logit3 = loss_fn(fea_k_byol2, feat_a_byol2)
